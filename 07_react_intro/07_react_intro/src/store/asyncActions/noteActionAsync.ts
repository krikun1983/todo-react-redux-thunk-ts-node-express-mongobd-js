...
export const addNoteAction = (note: DataNote) => (dispatch: Dispatch) => {
...
export const updateNoteAction = (notes: DataNote[]) => (dispatch: Dispatch) => {
  store.dispatch(toggleLoaderAction(true));
  Promise.resolve().then(() => {
    setTimeout(() => {
...
export const removeNoteAction = (id: number) => (dispatch: Dispatch) => {
  store.dispatch(toggleLoaderAction(true));
  Promise.resolve().then(() => {
    setTimeout(() => {
