      ...
      `
        <div class="modal-delete-container">
          <div class="modal-delete">
            <div class="modal-delete_product">Delete product ${productCurrent.name}?</div>
            <div class="modal-delete_question">Are you sure you want to perform this action</div>
            <div class="modal-delete_btns">
              <button type="button" data-action="delete-yes">Yes</button>
              <button type="button" data-action="delete-no" >No</button>
            </div>
          </div>
        </div>
      `
